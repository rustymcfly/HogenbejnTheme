...
class OfferFormValidationFactory implements DataValidationFactoryInterface
{
    /**
    ...
    {
        return $this->createOfferFormValidation('offer_form.create', $context);
    }

    public function update(SalesChannelContext $context): DataValidationDefinition
    {
        return $this->createOfferFormValidation('offer_form.update', $context);
    }

    private function createOfferFormValidation(string $validationName, SalesChannelContext $context): DataValidationDefinition
    {
        $definition = new DataValidationDefinition($validationName);

        $definition
            ->add('file', new NotBlank(), new File())
            ->add('salutationId', new NotBlank(), new EntityExists(['entity' => 'salutation', 'context' => $context->getContext()]))
            ->add('productId', new NotBlank(), new EntityExists(['entity' => 'product', 'context' => $context->getContext()]))
